    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {sortedNeeds.length > 0 ? (
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-900">No needs found</h2>
          <p className="text-gray-600 mt-2">There are currently no registered needs matching your criteria.</p>
        </div>
      )}
    </div>
  );
