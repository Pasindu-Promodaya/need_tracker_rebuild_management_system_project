            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="flex flex-wrap gap-4 pt-4 animate-fade-in-up">
                ...
                {user?.role === "ADMIN" && (
                  <>
                    <Link href="/needs" className="group relative px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg">
                      <span className="relative z-10">View All Needs</span>
                    </Link>
                    <Link href="/organizations" className="group px-8 py-4 bg-white bg-opacity-20 text-white font-bold rounded-xl hover:bg-opacity-30 transition-all duration-300 border-2 border-white border-opacity-40 hover:border-opacity-60 transform hover:scale-105 active:scale-95 backdrop-blur-sm">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              <Link href="/organizations" className="group relative overflow-hidden rounded-xl bg-white/85 border border-blue-100 p-6 backdrop-blur-sm hover:shadow-xl hover:-translate-y-1 hover:border-blue-200 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2">Manage Organizations</h3>
                  <p className="text-sm text-gray-600">Create, edit, and monitor all organizations</p>
                </div>
              </Link>
              ...
              <Link href="/needs" className="group relative overflow-hidden rounded-xl bg-white/85 border border-emerald-100 p-6 backdrop-blur-sm hover:shadow-xl hover:-translate-y-1 hover:border-emerald-200 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <h3 className="font-bold text-gray-900 mb-2">View All Needs</h3>
                  <p className="text-sm text-gray-600">Track all registered needs and donations</p>
                </div>
              </Link>
              ...
              <Link href="/documents" className="group relative overflow-hidden rounded-xl bg-white/85 border border-purple-100 p-6 backdrop-blur-sm hover:shadow-xl hover:-translate-y-1 hover:border-purple-200 transition-all duration-300">
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-gray-600">Process and manage proof of delivery</p>
                </div>
              </Link>
            </div>
          </div>
