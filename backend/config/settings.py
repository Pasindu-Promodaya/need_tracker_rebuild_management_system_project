...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS',
    default='localhost,127.0.0.1,62.171.171.71,62.171.171.71.sslip.io',
    cast=Csv()
)
...
FRONTEND_URL = config('FRONTEND_URL', default='http://62.171.171.71.sslip.io')
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:3000,http://127.0.0.1:3000,http://62.171.171.71.sslip.io',
    cast=Csv()
)
